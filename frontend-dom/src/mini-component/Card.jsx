    ...
    return (
        <div className="group relative bg-white border-2 border-black rounded-[2rem] transition-all hover:-translate-x-1 hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] w-full max-w-[450px] overflow-hidden">
            ...
            <div className="p-6 flex flex-col gap-4">
                ...
                <button className="w-full bg-black hover:bg-amber-400 text-white hover:text-black font-bold py-3 border-2 border-black rounded-xl transition-all active:translate-y-1 active:shadow-none uppercase text-xs tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                    Add to Cart
                </button>
            </div>
        </div>
